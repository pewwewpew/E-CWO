        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body" style="text-align:center">
                    ...
                    <form action="/admin/aircraft/{{$item->company_id}}/{{$item->aircraft_id}}" method="POST">
                        @csrf
                        @method("PUT")
                    ...
                    <div>
                        ...
                        <form action="/admin/aircraft/{{$item->company_id}}/{{$item->aircraft_id}}/{{$item->service_name}}/detail" method="get">
